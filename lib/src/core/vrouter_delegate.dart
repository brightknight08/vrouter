...
class VRouterDelegate extends RouterDelegate<RouteInformation> with ChangeNotifier {
  ...
  Future<void> _pop(VPopData vPopData) async {
    ...
    final List<VWidgetGuardMessageRoot> poppedVWidgetGuardsMessagesRoot = _vWidgetGuardMessagesRoot
        .where(
          (vWidgetGuardMessageRoot) =>
    ...
    for (var vRouteElement in poppedVRouteElements) {
      ...
      if (!vRedirector.shouldUpdate) {
        vRedirector.redirectFunction?.call(
          vRouterDelegate: this,
          vRouteElementNode:
              _vRoute.vRouteElementNode.getChildVRouteElementNode(vRouteElement: vRouteElement) ??
                  _vRoute.vRouteElementNode,
        );
        return;
      }
  ...
  DefaultPopResult _defaultPop(VPopData vPopData) {
    ...
    final poppedVRouteElements = poppedVRouteElementsFromVNode + poppedVRouteElementsFromPopResult;
  ...
  Future<void> setNewRoutePath(RouteInformation routeInformation) async {
    if (!routeInformation.uri.hasEmptyPath && !_ignoreNextBrowserCalls) {
      ...
      onNotification: (VWidgetGuardMessage vWidgetGuardMessage) {
        ...
        if (!_vWidgetGuardMessagesRoot.any(
          (message) =>
              ...
              message.associatedVRouteElement == vWidgetGuardMessageRoot.associatedVRouteElement,
        )) {
...
class RootVRouterData extends InheritedWidget with InitializedVRouterSailor {
  ...
  Widget Function(Animation<double> animation, Animation<double> secondaryAnimation, Widget child)?
